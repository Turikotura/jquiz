            ...
            <div id="upper" class="curved container">
                ...
                <div id="notice">
                    ...
                    <div id="tasks">
                        ...
                        <h4><a href="${tomcatDocUrl}security-howto.html">accounts.Security Considerations How-To</a></h4>
            ...
            <div id="lower">
                <div id="low-manage" class="">
                    <div class="curved container">
                        ...
                        <h4><a href="${tomcatUrl}security.html">accounts.Security Notices</a></h4>
                    </div>
                </div>
